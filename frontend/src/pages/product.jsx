    ...
    <div className='flex-1'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 px-6 py-6 text-sm text-gray-500'>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod voluptates excepturi expedita in animi amet libero nobis fugit, quo aperiam est maxime dolorem nisi! In nemo unde non sint eligendi.</p>

          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe perspiciatis autem distinctio nihil iusto voluptate commodi ad officiis aspernatur porro!</p>
        </div>
